(function(z,L){typeof exports=="object"&&typeof module<"u"?module.exports=L():typeof define=="function"&&define.amd?define(L):(z=typeof globalThis<"u"?globalThis:z||self,z.AIAgent=L())})(this,function(){"use strict";var Os=Object.defineProperty;var Sn=z=>{throw TypeError(z)};var Ds=(z,L,Q)=>L in z?Os(z,L,{enumerable:!0,configurable:!0,writable:!0,value:Q}):z[L]=Q;var m=(z,L,Q)=>Ds(z,typeof L!="symbol"?L+"":L,Q),Ls=(z,L,Q)=>L.has(z)||Sn("Cannot "+Q);var En=(z,L,Q)=>L.has(z)?Sn("Cannot add the same private member more than once"):L instanceof WeakSet?L.add(z):L.set(z,Q);var We=(z,L,Q)=>(Ls(z,L,"access private method"),Q);var ce,An,ia,Cn;function z(s){if(!s)return null;try{const e=s.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/");for(;t.length%4;)t+="=";const a=atob(t),n=JSON.parse(a);return typeof n.exp=="number"?n.exp:null}catch{return null}}class L{constructor(){m(this,"_accessToken",null);m(this,"_expEpoch",0)}async get(e){const t=Math.floor(Date.now()/1e3);if(this._accessToken&&this._expEpoch>t+30)return this._accessToken;console.log("[AIAgent SDK] token missing/near-expiry, calling getAccessToken()...");const a=await e();if(!a||!a.accessToken)throw new Error("getAccessToken() must return { accessToken }");return this._accessToken=a.accessToken,this._expEpoch=z(a.accessToken)||t+300,this._accessToken}}async function Q(s,e,t,a,n,i,o,l,d){const p=s.getReader(),g=new TextDecoder;let h="",b=!1;function _(){b||(b=!0,t())}function x(){for(;;){const C=h.indexOf(`

`);if(C<0)return;const E=h.slice(0,C);if(h=h.slice(C+2),!E)continue;const y={},K=E.split(`
`);for(let k=0;k<K.length;k++){const R=K[k],U=R.indexOf(":");if(U<0)continue;const D=R.slice(0,U).trim();let X=R.slice(U+1);X.length>0&&X.charAt(0)===" "&&(X=X.slice(1)),D==="data"?y.data=(y.data?y.data+`
`:"")+X:y[D]=X}if(y.data&&(y.data=y.data.replace(/\\n/g,`
`)),y.event==="tool_call_start"&&typeof o=="function"){try{const k=JSON.parse(y.data||"{}");console.log("[AIAgent SDK 🚀 tool_call_start]",k),o(k)}catch(k){console.error("[AIAgent SDK] tool_call_start parse failed",k,y.data)}continue}if(y.event==="tool_call"&&typeof n=="function"){try{const k=JSON.parse(y.data||"{}");console.log("[AIAgent SDK 🔧 tool_call]",k),n(k)}catch(k){console.error("[AIAgent SDK] tool_call parse failed",k,y.data)}continue}if(y.event==="tool_call_delta"&&typeof i=="function"){try{const k=JSON.parse(y.data||"{}");console.log("[AIAgent SDK 🔧 tool_call_delta]",k),i(k)}catch(k){console.error("[AIAgent SDK] tool_call_delta parse failed",k,y.data)}continue}if(y.event==="tool_call_end"&&typeof l=="function"){try{const k=y.data?JSON.parse(y.data):{};console.log("[AIAgent SDK 🏁 tool_call_end]",k),l(k)}catch{console.log("[AIAgent SDK 🏁 tool_call_end] (no data)"),l({})}continue}if(y.id==="last"){_();continue}if(y.event==="thinking"&&typeof d=="function"){d(y.data||"");continue}y.data!==void 0&&e(y)}}try{for(;;){const C=await p.read();if(C.done)break;h+=g.decode(C.value,{stream:!0}),x()}x(),_()}catch(C){a(C)}}function bt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let me=bt();function sa(s){me=s}const oa=/[&<>"']/,Rn=new RegExp(oa.source,"g"),ra=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,In=new RegExp(ra.source,"g"),On={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},la=s=>On[s];function ee(s,e){if(e){if(oa.test(s))return s.replace(Rn,la)}else if(ra.test(s))return s.replace(In,la);return s}const Dn=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Ln(s){return s.replace(Dn,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const Nn=/(^|[^\[])\^/g;function I(s,e){let t=typeof s=="string"?s:s.source;e=e||"";const a={replace:(n,i)=>{let o=typeof i=="string"?i:i.source;return o=o.replace(Nn,"$1"),t=t.replace(n,o),a},getRegex:()=>new RegExp(t,e)};return a}function da(s){try{s=encodeURI(s).replace(/%25/g,"%")}catch{return null}return s}const De={exec:()=>null};function ca(s,e){const t=s.replace(/\|/g,(i,o,l)=>{let d=!1,p=o;for(;--p>=0&&l[p]==="\\";)d=!d;return d?"|":" |"}),a=t.split(/ \|/);let n=0;if(a[0].trim()||a.shift(),a.length>0&&!a[a.length-1].trim()&&a.pop(),e)if(a.length>e)a.splice(e);else for(;a.length<e;)a.push("");for(;n<a.length;n++)a[n]=a[n].trim().replace(/\\\|/g,"|");return a}function Le(s,e,t){const a=s.length;if(a===0)return"";let n=0;for(;n<a&&s.charAt(a-n-1)===e;)n++;return s.slice(0,a-n)}function Mn(s,e){if(s.indexOf(e[1])===-1)return-1;let t=0;for(let a=0;a<s.length;a++)if(s[a]==="\\")a++;else if(s[a]===e[0])t++;else if(s[a]===e[1]&&(t--,t<0))return a;return-1}function pa(s,e,t,a){const n=e.href,i=e.title?ee(e.title):null,o=s[1].replace(/\\([\[\]])/g,"$1");if(s[0].charAt(0)!=="!"){a.state.inLink=!0;const l={type:"link",raw:t,href:n,title:i,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,l}return{type:"image",raw:t,href:n,title:i,text:ee(o)}}function zn(s,e){const t=s.match(/^(\s+)(?:```)/);if(t===null)return e;const a=t[1];return e.split(`
