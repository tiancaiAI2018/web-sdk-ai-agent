(function(M,D){typeof exports=="object"&&typeof module<"u"?module.exports=D():typeof define=="function"&&define.amd?define(D):(M=typeof globalThis<"u"?globalThis:M||self,M.AIAgent=D())})(this,function(){"use strict";var Ls=Object.defineProperty;var Sn=M=>{throw TypeError(M)};var Ds=(M,D,Q)=>D in M?Ls(M,D,{enumerable:!0,configurable:!0,writable:!0,value:Q}):M[D]=Q;var m=(M,D,Q)=>Ds(M,typeof D!="symbol"?D+"":D,Q),Ns=(M,D,Q)=>D.has(M)||Sn("Cannot "+Q);var En=(M,D,Q)=>D.has(M)?Sn("Cannot add the same private member more than once"):D instanceof WeakSet?D.add(M):D.set(M,Q);var We=(M,D,Q)=>(Ns(M,D,"access private method"),Q);var ce,An,ia,Cn;function M(s){if(!s)return null;try{const e=s.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/");for(;t.length%4;)t+="=";const a=atob(t),n=JSON.parse(a);return typeof n.exp=="number"?n.exp:null}catch{return null}}class D{constructor(){m(this,"_accessToken",null);m(this,"_expEpoch",0)}async get(e){const t=Math.floor(Date.now()/1e3);if(this._accessToken&&this._expEpoch>t+30)return this._accessToken;console.log("[AIAgent SDK] token missing/near-expiry, calling getAccessToken()...");const a=await e();if(!a||!a.accessToken)throw new Error("getAccessToken() must return { accessToken }");return this._accessToken=a.accessToken,this._expEpoch=M(a.accessToken)||t+300,this._accessToken}}async function Q(s,e,t,a,n,i,o,l,d){const p=s.getReader(),g=new TextDecoder;let h="",k=!1;function T(){k||(k=!0,t())}function x(){for(;;){const A=h.indexOf(`

`);if(A<0)return;const w=h.slice(0,A);if(h=h.slice(A+2),!w)continue;const y={},q=w.split(`
`);for(let b=0;b<q.length;b++){const I=q[b],H=I.indexOf(":");if(H<0)continue;const L=I.slice(0,H).trim();let V=I.slice(H+1);V.length>0&&V.charAt(0)===" "&&(V=V.slice(1)),L==="data"?y.data=(y.data?y.data+`
`:"")+V:y[L]=V}if(y.data&&(y.data=y.data.replace(/\\n/g,`
`)),y.event==="tool_call_start"&&typeof o=="function"){try{const b=JSON.parse(y.data||"{}");console.log("[AIAgent SDK 🚀 tool_call_start]",b),o(b)}catch(b){console.error("[AIAgent SDK] tool_call_start parse failed",b,y.data)}continue}if(y.event==="tool_call"&&typeof n=="function"){try{const b=JSON.parse(y.data||"{}");console.log("[AIAgent SDK 🔧 tool_call]",b),n(b)}catch(b){console.error("[AIAgent SDK] tool_call parse failed",b,y.data)}continue}if(y.event==="tool_call_delta"&&typeof i=="function"){try{const b=JSON.parse(y.data||"{}");console.log("[AIAgent SDK 🔧 tool_call_delta]",b),i(b)}catch(b){console.error("[AIAgent SDK] tool_call_delta parse failed",b,y.data)}continue}if(y.event==="tool_call_end"&&typeof l=="function"){try{const b=y.data?JSON.parse(y.data):{};console.log("[AIAgent SDK 🏁 tool_call_end]",b),l(b)}catch{console.log("[AIAgent SDK 🏁 tool_call_end] (no data)"),l({})}continue}if(y.id==="last"){T();continue}if(y.event==="thinking"&&typeof d=="function"){d(y.data||"");continue}y.data!==void 0&&e(y)}}try{for(;;){const A=await p.read();if(A.done)break;h+=g.decode(A.value,{stream:!0}),x()}x(),T()}catch(A){a(A)}}function bt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let me=bt();function sa(s){me=s}const oa=/[&<>"']/,In=new RegExp(oa.source,"g"),ra=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Rn=new RegExp(ra.source,"g"),On={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},la=s=>On[s];function ee(s,e){if(e){if(oa.test(s))return s.replace(In,la)}else if(ra.test(s))return s.replace(Rn,la);return s}const Ln=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Dn(s){return s.replace(Ln,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const Nn=/(^|[^\[])\^/g;function R(s,e){let t=typeof s=="string"?s:s.source;e=e||"";const a={replace:(n,i)=>{let o=typeof i=="string"?i:i.source;return o=o.replace(Nn,"$1"),t=t.replace(n,o),a},getRegex:()=>new RegExp(t,e)};return a}function da(s){try{s=encodeURI(s).replace(/%25/g,"%")}catch{return null}return s}const Le={exec:()=>null};function ca(s,e){const t=s.replace(/\|/g,(i,o,l)=>{let d=!1,p=o;for(;--p>=0&&l[p]==="\\";)d=!d;return d?"|":" |"}),a=t.split(/ \|/);let n=0;if(a[0].trim()||a.shift(),a.length>0&&!a[a.length-1].trim()&&a.pop(),e)if(a.length>e)a.splice(e);else for(;a.length<e;)a.push("");for(;n<a.length;n++)a[n]=a[n].trim().replace(/\\\|/g,"|");return a}function De(s,e,t){const a=s.length;if(a===0)return"";let n=0;for(;n<a&&s.charAt(a-n-1)===e;)n++;return s.slice(0,a-n)}function Pn(s,e){if(s.indexOf(e[1])===-1)return-1;let t=0;for(let a=0;a<s.length;a++)if(s[a]==="\\")a++;else if(s[a]===e[0])t++;else if(s[a]===e[1]&&(t--,t<0))return a;return-1}function pa(s,e,t,a){const n=e.href,i=e.title?ee(e.title):null,o=s[1].replace(/\\([\[\]])/g,"$1");if(s[0].charAt(0)!=="!"){a.state.inLink=!0;const l={type:"link",raw:t,href:n,title:i,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,l}return{type:"image",raw:t,href:n,title:i,text:ee(o)}}function Mn(s,e){const t=s.match(/^(\s+)(?:```)/);if(t===null)return e;const a=t[1];return e.split(`
...
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const a=t[0],n=Mn(a,t[3]||"");return{type:"code",raw:a,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:n}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let a=t[2].trim();if(/#$/.test(a)){const n=De(a,"#");(this.options.pedantic||!n||/ $/.test(n))&&(a=n.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:a,tokens:this.lexer.inline(a)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:De(t[0],`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${e}</code>`}br(e){return"<br>"}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:a}){const n=this.parser.parseInline(a),i=da(e);if(i===null)return n;e=i;let o='<a href="'+e+'"';return t&&(o+=' title="'+t+'"'),o+=">"+n+"</a>",o}image({href:e,title:t,text:a}){const n=da(e);if(n===null)return a;e=n;let i=`<img src="${e}" alt="${a}"`;return t&&(i+=` title="${t}"`),i+=">",i}text(e){return"tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):e.text}}class St{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return""+e}image({text:e}){return""+e}br(){return""}}class ie{constructor(e){m(this,"options");m(this,"renderer");m(this,"textRenderer");this.options=e||me,this.options.renderer=this.options.renderer||new Xe,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new St}static parse(e,t){return new ie(t).parse(e)}static parseInline(e,t){return new ie(t).parseInline(e)}parse(e,t=!0){let a="";for(let n=0;n<e.length;n++){const i=e[n];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){const l=i,d=this.options.extensions.renderers[l.type].call({parser:this},l);if(d!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(l.type)){a+=d||"";continue}}const o=i;switch(o.type){case"space":{a+=this.renderer.space(o);continue}case"hr":{a+=this.renderer.hr(o);continue}case"heading":{a+=this.renderer.heading(o);continue}case"code":{a+=this.renderer.code(o);continue}case"table":{a+=this.renderer.table(o);continue}case"blockquote":{a+=this.renderer.blockquote(o);continue}case"list":{a+=this.renderer.list(o);continue}case"html":{a+=this.renderer.html(o);continue}case"paragraph":{a+=this.renderer.paragraph(o);continue}case"text":{let l=o,d=this.renderer.text(l);for(;n+1<e.length&&e[n+1].type==="text";)l=e[++n],d+=`
`+this.renderer.text(l);t?a+=this.renderer.paragraph({type:"paragraph",raw:d,text:d,tokens:[{type:"text",raw:d,text:d}]}):a+=d;continue}default:{const l='Token with "'+o.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return a}parseInline(e,t){t=t||this.renderer;let a="";for(let n=0;n<e.length;n++){const i=e[n];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){const l=this.options.extensions.renderers[i.type].call({parser:this},i);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){a+=l||"";continue}}const o=i;switch(o.type){case"escape":{a+=t.text(o);break}case"html":{a+=t.html(o);break}case"link":{a+=t.link(o);break}case"image":{a+=t.image(o);break}case"strong":{a+=t.strong(o);break}case"em":{a+=t.em(o);break}case"codespan":{a+=t.codespan(o);break}case"br":{a+=t.br(o);break}case"del":{a+=t.del(o);break}case"text":{a+=t.text(o);break}default:{const l='Token with "'+o.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return a}}class ze{constructor(e){m(this,"options");this.options=e||me}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}}m(ze,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));class li{constructor(...e){En(this,ce);m(this,"defaults",bt());m(this,"options",this.setOptions);m(this,"parse",We(this,ce,ia).call(this,ne.lex,ie.parse));m(this,"parseInline",We(this,ce,ia).call(this,ne.lexInline,ie.parseInline));m(this,"Parser",ie);m(this,"Renderer",Xe);m(this,"TextRenderer",St);m(this,"Lexer",ne);m(this,"Tokenizer",Ye);m(this,"Hooks",ze);this.use(...e)}walkTokens(e,t){let a=[];for(const n of e)switch(a=a.concat(t.call(this,n)),n.type){case"table":{const i=n;for(const o of i.header)a=a.concat(this.walkTokens(o.tokens,t));for(const o of i.rows)for(const l of o)a=a.concat(this.walkTokens(l.tokens,t));break}case"list":{const i=n;a=a.concat(this.walkTokens(i.items,t));break}default:{const i=n;this.defaults.extensions?.childTokens?.[i.type]?this.defaults.extensions.childTokens[i.type].forEach(o=>{const l=i[o].flat(1/0);a=a.concat(this.walkTokens(l,t))}):i.tokens&&(a=a.concat(this.walkTokens(i.tokens,t)))}}return a}use(...e){const t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(a=>{const n={...a};if(n.async=this.defaults.async||n.async||!1,a.extensions&&(a.extensions.forEach(i=>{if(!i.name)throw new Error("extension name required");if("renderer"in i){const o=t.renderers[i.name];o?t.renderers[i.name]=function(...l){let d=i.renderer.apply(this,l);return d===!1&&(d=o.apply(this,l)),d}:t.renderers[i.name]=i.renderer}if("tokenizer"in i){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const o=t[i.level];o?o.unshift(i.tokenizer):t[i.level]=[i.tokenizer],i.start&&(i.level==="block"?t.startBlock?t.startBlock.push(i.start):t.startBlock=[i.start]:i.level==="inline"&&(t.startInline?t.startInline.push(i.start):t.startInline=[i.start]))}"childTokens"in i&&i.childTokens&&(t.childTokens[i.name]=i.childTokens)}),n.extensions=t),a.renderer){const i=this.defaults.renderer||new Xe(this.defaults);for(const o in a.renderer){if(!(o in i))throw new Error(`renderer '${o}' does not exist`);if(["options","parser"].includes(o))continue;const l=o;let d=a.renderer[l];a.useNewRenderer||(d=We(this,ce,An).call(this,d,l,i));const p=i[l];i[l]=(...g)=>{let h=d.apply(i,g);return h===!1&&(h=p.apply(i,g)),h||""}}n.renderer=i}if(a.tokenizer){const i=this.defaults.tokenizer||new Ye(this.defaults);for(const o in a.tokenizer){if(!(o in i))throw new Error(`tokenizer '${o}' does not exist`);if(["options","rules","lexer"].includes(o))continue;const l=o,d=a.tokenizer[l],p=i[l];i[l]=(...g)=>{let h=d.apply(i,g);return h===!1&&(h=p.apply(i,g)),h}}n.tokenizer=i}if(a.hooks){const i=this.defaults.hooks||new ze;for(const o in a.hooks){if(!(o in i))throw new Error(`hook '${o}' does not exist`);if(o==="options")continue;const l=o,d=a.hooks[l],p=i[l];ze.passThroughHooks.has(o)?i[l]=g=>{if(this.defaults.async)return Promise.resolve(d.call(i,g)).then(k=>p.call(i,k));const h=d.call(i,g);return p.call(i,h)}:i[l]=(...g)=>{let h=d.apply(i,g);return h===!1&&(h=p.apply(i,g)),h}}n.hooks=i}if(a.walkTokens){const i=this.defaults.walkTokens,o=a.walkTokens;n.walkTokens=function(l){let d=[];return d.push(o.call(this,l)),i&&(d=d.concat(i.call(this,l))),d}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return ne.lex(e,t??this.defaults)}parser(e,t){return ie.parse(e,t??this.defaults)}}ce=new WeakSet,An=function(e,t,a){switch(t){case"heading":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,a.parser.parseInline(n.tokens),n.depth,Dn(a.parser.parseInline(n.tokens,a.parser.textRenderer)))};case"code":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.text,n.lang,!!n.escaped)};case"table":return function(n){if(!n.type||n.type!==t)return e.apply(this,arguments);let i="",o="";for(let d=0;d<n.header.length;d++)o+=this.tablecell({text:n.header[d].text,tokens:n.header[d].tokens,header:!0,align:n.align[d]});i+=this.tablerow({text:o});let l="";for(let d=0;d<n.rows.length;d++){const p=n.rows[d];o="";for(let g=0;g<p.length;g++)o+=this.tablecell({text:p[g].text,tokens:p[g].tokens,header:!1,align:n.align[g]});l+=this.tablerow({text:o})}return e.call(this,i,l)};case"blockquote":return function(n){if(!n.type||n.type!==t)return e.apply(this,arguments);const i=this.parser.parse(n.tokens);return e.call(this,i)};case"list":return function(n){if(!n.type||n.type!==t)return e.apply(this,arguments);const i=n.ordered,o=n.start,l=n.loose;let d="";for(let p=0;p<n.items.length;p++){const g=n.items[p],h=g.checked,k=g.task;let T="";if(g.task){const x=this.checkbox({checked:!!h});l?g.tokens.length>0&&g.tokens[0].type==="paragraph"?(g.tokens[0].text=x+" "+g.tokens[0].text,g.tokens[0].tokens&&g.tokens[0].tokens.length>0&&g.tokens[0].tokens[0].type==="text"&&(g.tokens[0].tokens[0].text=x+" "+g.tokens[0].tokens[0].text)):g.tokens.unshift({type:"text",text:x+" "}):T+=x+" "}T+=this.parser.parse(g.tokens,l),d+=this.listitem({type:"list_item",raw:T,text:T,task:k,checked:!!h,loose:l,tokens:g.tokens})}return e.call(this,d,i,o)};case"html":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.text,n.block)};case"paragraph":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,this.parser.parseInline(n.tokens))};case"escape":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.text)};case"link":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.href,n.title,this.parser.parseInline(n.tokens))};case"image":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.href,n.title,n.text)};case"strong":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,this.parser.parseInline(n.tokens))};case"em":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,this.parser.parseInline(n.tokens))};case"codespan":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.text)};case"del":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,this.parser.parseInline(n.tokens))};case"text":return function(n){return!n.type||n.type!==t?e.apply(this,arguments):e.call(this,n.text)}}return e},ia=function(e,t){return(a,n)=>{const i={...n},o={...this.defaults,...i};this.defaults.async===!0&&i.async===!1&&(o.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),o.async=!0);const l=We(this,ce,Cn).call(this,!!o.silent,!!o.async);if(typeof a>"u"||a===null)return l(new Error("marked(): input parameter is undefined or null"));if(typeof a!="string")return l(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(a)+", string expected"));if(o.hooks&&(o.hooks.options=o),o.async)return Promise.resolve(o.hooks?o.hooks.preprocess(a):a).then(d=>e(d,o)).then(d=>o.hooks?o.hooks.processAllTokens(d):d).then(d=>o.walkTokens?Promise.all(this.walkTokens(d,o.walkTokens)).then(()=>d):d).then(d=>t(d,o)).then(d=>o.hooks?o.hooks.postprocess(d):d).catch(l);try{o.hooks&&(a=o.hooks.preprocess(a));let d=e(a,o);o.hooks&&(d=o.hooks.processAllTokens(d)),o.walkTokens&&this.walkTokens(d,o.walkTokens);let p=t(d,o);return o.hooks&&(p=o.hooks.postprocess(p)),p}catch(d){return l(d)}}},Cn=function(e,t){return a=>{if(a.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+ee(a.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(a);throw a}};const ke=new li;function C(s,e){return ke.parse(s,e)}C.options=C.setOptions=function(s){return ke.setOptions(s),C.defaults=ke.defaults,sa(C.defaults),C},C.getDefaults=bt,C.defaults=me,C.use=function(...s){return ke.use(...s),C.defaults=ke.defaults,sa(C.defaults),C},C.walkTokens=function(s,e){return ke.walkTokens(s,e)},C.parseInline=ke.parseInline,C.Parser=ie,C.parser=ie.parse,C.Renderer=Xe,C.TextRenderer=St,C.Lexer=ne,C.lexer=ne.lex,C.Tokenizer=Ye,C.Hooks=ze,C.parse=C,C.options,C.setOptions,C.use,C.walkTokens,C.parseInline,ie.parse,ne.lex;/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function ya(s,e){(e==null||e>s.length)&&(e=s.length);for(var t=0,a=Array(e);t<e;t++)a[t]=s[t];return a}function di(s){if(Array.isArray(s))return s}function ci(s,e){var t=s==null?null:typeof Symbol<"u"&&s[Symbol.iterator]||s["@@iterator"];if(t!=null){var a,n,i,o,l=[],d=!0,p=!1;try{if(i=(t=t.call(s)).next,e!==0)for(;!(d=(a=i.call(t)).done)&&(l.push(a.value),l.length!==e);d=!0);}catch(g){p=!0,n=g}finally{try{if(!d&&t.return!=null&&(o=t.return(),Object(o)!==o))return}finally{if(p)throw n}}return l}}function pi(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function gi(s,e){return di(s)||ci(s,e)||ui(s,e)||pi()}function ui(s,e){if(s){if(typeof s=="string")return ya(s,e);var t={}.toString.call(s).slice(8,-1);return t==="Object"&&s.constructor&&(t=s.constructor.name),t==="Map"||t==="Set"?Array.from(s):t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?ya(s,e):void 0}}const wa=Object.entries,va=Object.setPrototypeOf,hi=Object.isFrozen,fi=Object.getPrototypeOf,mi=Object.getOwnPropertyDescriptor;let Z=Object.freeze,te=Object.seal,Te=Object.create,Ta=typeof Reflect<"u"&&Reflect,Et=Ta.apply,At=Ta.construct;Z||(Z=function(e){return e}),te||(te=function(e){return e}),Et||(Et=function(e,t){for(var a=arguments.length,n=new Array(a>2?a-2:0),i=2;i<a;i++)n[i-2]=arguments[i];return e.apply(t,n)}),At||(At=function(e){for(var t=arguments.length,a=new Array(t>1?t-1:0),n=1;n<t;n++)a[n-1]=arguments[n];return new e(...a)});const de=F(Array.prototype.forEach),ki=F(Array.prototype.lastIndexOf),_a=F(Array.prototype.pop),_e=F(Array.prototype.push),bi=F(Array.prototype.splice),J=Array.isArray,$e=F(String.prototype.toLowerCase),Ct=F(String.prototype.toString),Sa=F(String.prototype.match),Se=F(String.prototype.replace),Ea=F(String.prototype.indexOf),xi=F(String.prototype.trim),yi=F(Number.prototype.toString),wi=F(Boolean.prototype.toString),Aa=typeof BigInt>"u"?null:F(BigInt.prototype.toString),Ca=typeof Symbol>"u"?null:F(Symbol.prototype.toString),N=F(Object.prototype.hasOwnProperty),Be=F(Object.prototype.toString),Y=F(RegExp.prototype.test),be=vi(TypeError);function F(s){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,a=new Array(t>1?t-1:0),n=1;n<t;n++)a[n-1]=arguments[n];return Et(s,e,a)}}function vi(s){return function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];return At(s,t)}}function S(s,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:$e;if(va&&va(s,null),!J(e))return s;let a=e.length;for(;a--;){let n=e[a];if(typeof n=="string"){const i=t(n);i!==n&&(hi(e)||(e[a]=i),n=i)}s[n]=!0}return s}function Ti(s){for(let e=0;e<s.length;e++)N(s,e)||(s[e]=null);return s}function K(s){const e=Te(null);for(const a of wa(s)){var t=gi(a,2);const n=t[0],i=t[1];N(s,n)&&(J(i)?e[n]=Ti(i):i&&typeof i=="object"&&i.constructor===Object?e[n]=K(i):e[n]=i)}return e}function _i(s){switch(typeof s){case"string":return s;case"number":return yi(s);case"boolean":return wi(s);case"bigint":return Aa?Aa(s):"0";case"symbol":return Ca?Ca(s):"Symbol()";case"undefined":return Be(s);case"function":case"object":{if(s===null)return Be(s);const e=s,t=se(e,"toString");if(typeof t=="function"){const a=t(e);return typeof a=="string"?a:Be(a)}return Be(s)}default:return Be(s)}}function se(s,e){for(;s!==null;){const a=mi(s,e);if(a){if(a.get)return F(a.get);if(typeof a.value=="function")return F(a.value)}s=fi(s)}function t(){return null}return t}function Si(s){try{return Y(s,""),!0}catch{return!1}}const Ia=Z(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),It=Z(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Rt=Z(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Ei=Z(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ot=Z(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Ai=Z(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Ra=Z(["#text"]),Oa=Z(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Lt=Z(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),La=Z(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ve=Z(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Ci=te(/{{[\w\W]*|^[\w\W]*}}/g),Ii=te(/<%[\w\W]*|^[\w\W]*%>/g),Ri=te(/\${[\w\W]*/g),Oi=te(/^data-[\-\w.\u00B7-\uFFFF]+$/),Li=te(/^aria-[\-\w]+$/),Da=te(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Di=te(/^(?:\w+script|data):/i),Ni=te(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Pi=te(/^html$/i),Mi=te(/^[a-z][.\w]*(-[.\w]+)+$/i),oe={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},zi=function(){return typeof window>"u"?null:window},$i=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let a=null;const n="data-tt-policy-suffix";t&&t.hasAttribute(n)&&(a=t.getAttribute(n));const i="dompurify"+(a?"#"+a:"");try{return e.createPolicy(i,{createHTML(o){return o},createScriptURL(o){return o}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Na=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Pa(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:zi();const e=f=>Pa(f);if(e.version="3.4.9",e.removed=[],!s||!s.document||s.document.nodeType!==oe.document||!s.Element)return e.isSupported=!1,e;let t=s.document;const a=t,n=a.currentScript;s.DocumentFragment;const i=s.HTMLTemplateElement,o=s.Node,l=s.Element,d=s.NodeFilter,p=s.NamedNodeMap;p===void 0&&(s.NamedNodeMap||s.MozNamedAttrMap),s.HTMLFormElement;const g=s.DOMParser,h=s.trustedTypes,k=l.prototype,T=se(k,"cloneNode"),x=se(k,"remove"),A=se(k,"nextSibling"),w=se(k,"childNodes"),y=se(k,"parentNode"),q=se(k,"shadowRoot"),b=se(k,"attributes"),I=o&&o.prototype?se(o.prototype,"nodeType"):null,H=o&&o.prototype?se(o.prototype,"nodeName"):null;if(typeof i=="function"){const f=t.createElement("template");f.content&&f.content.ownerDocument&&(t=f.content.ownerDocument)}let L,V="",Ut,Va=!1,Fe=0;const Qa=function(){if(Fe>0)throw be('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},Ee=function(r){Qa(),Fe++;try{return L.createHTML(r)}finally{Fe--}},hs=function(r){Qa(),Fe++;try{return L.createScriptURL(r)}finally{Fe--}},fs=function(){return Va||(Ut=$i(h,n),Va=!0),Ut},rt=t,Ft=rt.implementation,en=rt.createNodeIterator,ms=rt.createDocumentFragment,ks=rt.getElementsByTagName,bs=a.importNode;let G=Na();e.isSupported=typeof wa=="function"&&typeof y=="function"&&Ft&&Ft.createHTMLDocument!==void 0;const lt=Ci,dt=Ii,ct=Ri,xs=Oi,ys=Li,ws=Di,tn=Ni,vs=Mi;let an=Da,z=null;const Ht=S({},[...Ia,...It,...Rt,...Ot,...Ra]);let $=null;const jt=S({},[...Oa,...Lt,...La,...Ve]);let B=Object.seal(Te(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),He=null,pt=null;const ue=Object.seal(Te(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let nn=!0,qt=!0,sn=!1,on=!0,he=!1,je=!0,we=!1,Gt=!1,Wt=!1,Ae=!1,gt=!1,ut=!1,rn=!0,ln=!1;const dn="user-content-";let Yt=!0,Kt=!1,Ce={},re=null;const Zt=S({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let cn=null;const pn=S({},["audio","video","img","source","image","track"]);let Jt=null;const gn=S({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ht="http://www.w3.org/1998/Math/MathML",ft="http://www.w3.org/2000/svg",le="http://www.w3.org/1999/xhtml";let Ie=le,Xt=!1,Vt=null;const Ts=S({},[ht,ft,le],Ct);let Qt=S({},["mi","mo","mn","ms","mtext"]),ea=S({},["annotation-xml"]);const _s=S({},["title","style","font","a","script"]);let qe=null;const Ss=["application/xhtml+xml","text/html"],Es="text/html";let P=null,Re=null;const As=t.createElement("form"),un=function(r){return r instanceof RegExp||r instanceof Function},ta=function(){let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Re&&Re===r)return;(!r||typeof r!="object")&&(r={}),r=K(r),qe=Ss.indexOf(r.PARSER_MEDIA_TYPE)===-1?Es:r.PARSER_MEDIA_TYPE,P=qe==="application/xhtml+xml"?Ct:$e,z=N(r,"ALLOWED_TAGS")&&J(r.ALLOWED_TAGS)?S({},r.ALLOWED_TAGS,P):Ht,$=N(r,"ALLOWED_ATTR")&&J(r.ALLOWED_ATTR)?S({},r.ALLOWED_ATTR,P):jt,Vt=N(r,"ALLOWED_NAMESPACES")&&J(r.ALLOWED_NAMESPACES)?S({},r.ALLOWED_NAMESPACES,Ct):Ts,Jt=N(r,"ADD_URI_SAFE_ATTR")&&J(r.ADD_URI_SAFE_ATTR)?S(K(gn),r.ADD_URI_SAFE_ATTR,P):gn,cn=N(r,"ADD_DATA_URI_TAGS")&&J(r.ADD_DATA_URI_TAGS)?S(K(pn),r.ADD_DATA_URI_TAGS,P):pn,re=N(r,"FORBID_CONTENTS")&&J(r.FORBID_CONTENTS)?S({},r.FORBID_CONTENTS,P):Zt,He=N(r,"FORBID_TAGS")&&J(r.FORBID_TAGS)?S({},r.FORBID_TAGS,P):K({}),pt=N(r,"FORBID_ATTR")&&J(r.FORBID_ATTR)?S({},r.FORBID_ATTR,P):K({}),Ce=N(r,"USE_PROFILES")?r.USE_PROFILES&&typeof r.USE_PROFILES=="object"?K(r.USE_PROFILES):r.USE_PROFILES:!1,nn=r.ALLOW_ARIA_ATTR!==!1,qt=r.ALLOW_DATA_ATTR!==!1,sn=r.ALLOW_UNKNOWN_PROTOCOLS||!1,on=r.ALLOW_SELF_CLOSE_IN_ATTR!==!1,he=r.SAFE_FOR_TEMPLATES||!1,je=r.SAFE_FOR_XML!==!1,we=r.WHOLE_DOCUMENT||!1,Ae=r.RETURN_DOM||!1,gt=r.RETURN_DOM_FRAGMENT||!1,ut=r.RETURN_TRUSTED_TYPE||!1,Wt=r.FORCE_BODY||!1,rn=r.SANITIZE_DOM!==!1,ln=r.SANITIZE_NAMED_PROPS||!1,Yt=r.KEEP_CONTENT!==!1,Kt=r.IN_PLACE||!1,an=Si(r.ALLOWED_URI_REGEXP)?r.ALLOWED_URI_REGEXP:Da,Ie=typeof r.NAMESPACE=="string"?r.NAMESPACE:le,Qt=N(r,"MATHML_TEXT_INTEGRATION_POINTS")&&r.MATHML_TEXT_INTEGRATION_POINTS&&typeof r.MATHML_TEXT_INTEGRATION_POINTS=="object"?K(r.MATHML_TEXT_INTEGRATION_POINTS):S({},["mi","mo","mn","ms","mtext"]),ea=N(r,"HTML_INTEGRATION_POINTS")&&r.HTML_INTEGRATION_POINTS&&typeof r.HTML_INTEGRATION_POINTS=="object"?K(r.HTML_INTEGRATION_POINTS):S({},["annotation-xml"]);const c=N(r,"CUSTOM_ELEMENT_HANDLING")&&r.CUSTOM_ELEMENT_HANDLING&&typeof r.CUSTOM_ELEMENT_HANDLING=="object"?K(r.CUSTOM_ELEMENT_HANDLING):Te(null);if(B=Te(null),N(c,"tagNameCheck")&&un(c.tagNameCheck)&&(B.tagNameCheck=c.tagNameCheck),N(c,"attributeNameCheck")&&un(c.attributeNameCheck)&&(B.attributeNameCheck=c.attributeNameCheck),N(c,"allowCustomizedBuiltInElements")&&typeof c.allowCustomizedBuiltInElements=="boolean"&&(B.allowCustomizedBuiltInElements=c.allowCustomizedBuiltInElements),he&&(qt=!1),gt&&(Ae=!0),Ce&&(z=S({},Ra),$=Te(null),Ce.html===!0&&(S(z,Ia),S($,Oa)),Ce.svg===!0&&(S(z,It),S($,Lt),S($,Ve)),Ce.svgFilters===!0&&(S(z,Rt),S($,Lt),S($,Ve)),Ce.mathMl===!0&&(S(z,Ot),S($,La),S($,Ve))),ue.tagCheck=null,ue.attributeCheck=null,N(r,"ADD_TAGS")&&(typeof r.ADD_TAGS=="function"?ue.tagCheck=r.ADD_TAGS:J(r.ADD_TAGS)&&(z===Ht&&(z=K(z)),S(z,r.ADD_TAGS,P))),N(r,"ADD_ATTR")&&(typeof r.ADD_ATTR=="function"?ue.attributeCheck=r.ADD_ATTR:J(r.ADD_ATTR)&&($===jt&&($=K($)),S($,r.ADD_ATTR,P))),N(r,"ADD_URI_SAFE_ATTR")&&J(r.ADD_URI_SAFE_ATTR)&&S(Jt,r.ADD_URI_SAFE_ATTR,P),N(r,"FORBID_CONTENTS")&&J(r.FORBID_CONTENTS)&&(re===Zt&&(re=K(re)),S(re,r.FORBID_CONTENTS,P)),N(r,"ADD_FORBID_CONTENTS")&&J(r.ADD_FORBID_CONTENTS)&&(re===Zt&&(re=K(re)),S(re,r.ADD_FORBID_CONTENTS,P)),Yt&&(z["#text"]=!0),we&&S(z,["html","head","body"]),z.table&&(S(z,["tbody"]),delete He.tbody),r.TRUSTED_TYPES_POLICY){if(typeof r.TRUSTED_TYPES_POLICY.createHTML!="function")throw be('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof r.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw be('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const u=L;L=r.TRUSTED_TYPES_POLICY;try{V=Ee("")}catch(v){throw L=u,v}}else r.TRUSTED_TYPES_POLICY===null?(L=void 0,V=""):(L===void 0&&(L=fs()),L&&typeof V=="string"&&(V=Ee("")));(G.uponSanitizeElement.length>0||G.uponSanitizeAttribute.length>0)&&z===Ht&&(z=K(z)),G.uponSanitizeAttribute.length>0&&$===jt&&($=K($)),Z&&Z(r),Re=r},hn=S({},[...It,...Rt,...Ei]),fn=S({},[...Ot,...Ai]),Cs=function(r){let c=y(r);(!c||!c.tagName)&&(c={namespaceURI:Ie,tagName:"template"});const u=$e(r.tagName),v=$e(c.tagName);return Vt[r.namespaceURI]?r.namespaceURI===ft?c.namespaceURI===le?u==="svg":c.namespaceURI===ht?u==="svg"&&(v==="annotation-xml"||Qt[v]):!!hn[u]:r.namespaceURI===ht?c.namespaceURI===le?u==="math":c.namespaceURI===ft?u==="math"&&ea[v]:!!fn[u]:r.namespaceURI===le?c.namespaceURI===ft&&!ea[v]||c.namespaceURI===ht&&!Qt[v]?!1:!fn[u]&&(_s[u]||!hn[u]):!!(qe==="application/xhtml+xml"&&Vt[r.namespaceURI]):!1},ae=function(r){_e(e.removed,{element:r});try{y(r).removeChild(r)}catch{if(x(r),!y(r))throw be("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},mn=function(r){const c=w?w(r):r.childNodes;if(c){const v=[];de(c,_=>{_e(v,_)}),de(v,_=>{try{x(_)}catch{}})}const u=b?b(r):null;if(u)for(let v=u.length-1;v>=0;--v){const _=u[v],E=_&&_.name;if(typeof E=="string")try{r.removeAttribute(E)}catch{}}},ve=function(r,c){try{_e(e.removed,{attribute:c.getAttributeNode(r),from:c})}catch{_e(e.removed,{attribute:null,from:c})}if(c.removeAttribute(r),r==="is")if(Ae||gt)try{ae(c)}catch{}else try{c.setAttribute(r,"")}catch{}},Is=function(r){const c=b?b(r):r.attributes;if(c)for(let u=c.length-1;u>=0;--u){const v=c[u],_=v&&v.name;if(!(typeof _!="string"||$[P(_)]))try{r.removeAttribute(_)}catch{}}},Rs=function(r){const c=[r];for(;c.length>0;){const u=c.pop();(I?I(u):u.nodeType)===oe.element&&Is(u);const _=w?w(u):u.childNodes;if(_)for(let E=_.length-1;E>=0;--E)c.push(_[E])}},kn=function(r){let c=null,u=null;if(Wt)r="<remove></remove>"+r;else{const E=Sa(r,/^[\r\n\t ]+/);u=E&&E[0]}qe==="application/xhtml+xml"&&Ie===le&&(r='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+r+"</body></html>");const v=L?Ee(r):r;if(Ie===le)try{c=new g().parseFromString(v,qe)}catch{}if(!c||!c.documentElement){c=Ft.createDocument(Ie,"template",null);try{c.documentElement.innerHTML=Xt?V:v}catch{}}const _=c.body||c.documentElement;return r&&u&&_.insertBefore(t.createTextNode(u),_.childNodes[0]||null),Ie===le?ks.call(c,we?"html":"body")[0]:we?c.documentElement:_},bn=function(r){return en.call(r.ownerDocument||r,r,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT|d.SHOW_PROCESSING_INSTRUCTION|d.SHOW_CDATA_SECTION,null)},aa=function(r){var c,u;r.normalize();const v=en.call(r.ownerDocument||r,r,d.SHOW_TEXT|d.SHOW_COMMENT|d.SHOW_CDATA_SECTION|d.SHOW_PROCESSING_INSTRUCTION,null);let _=v.nextNode();for(;_;){let j=_.data;de([lt,dt,ct],O=>{j=Se(j,O," ")}),_.data=j,_=v.nextNode()}const E=(c=(u=r.querySelectorAll)===null||u===void 0?void 0:u.call(r,"template"))!==null&&c!==void 0?c:[];de(Array.from(E),j=>{Oe(j.content)&&aa(j.content)})},mt=function(r){const c=H?H(r):null;return typeof c!="string"||P(c)!=="form"?!1:typeof r.nodeName!="string"||typeof r.textContent!="string"||typeof r.removeChild!="function"||r.attributes!==b(r)||typeof r.removeAttribute!="function"||typeof r.setAttribute!="function"||typeof r.namespaceURI!="string"||typeof r.insertBefore!="function"||typeof r.hasChildNodes!="function"||r.nodeType!==I(r)||r.childNodes!==w(r)},Oe=function(r){if(!I||typeof r!="object"||r===null)return!1;try{return I(r)===oe.documentFragment}catch{return!1}},Ge=function(r){if(!I||typeof r!="object"||r===null)return!1;try{return typeof I(r)=="number"}catch{return!1}};function pe(f,r,c){de(f,u=>{u.call(e,r,c,Re)})}const xn=function(r){let c=null;if(pe(G.beforeSanitizeElements,r,null),mt(r))return ae(r),!0;const u=P(H?H(r):r.nodeName);if(pe(G.uponSanitizeElement,r,{tagName:u,allowedTags:z}),je&&r.hasChildNodes()&&!Ge(r.firstElementChild)&&Y(/<[/\w!]/g,r.innerHTML)&&Y(/<[/\w!]/g,r.textContent)||je&&r.namespaceURI===le&&u==="style"&&Ge(r.firstElementChild)||r.nodeType===oe.progressingInstruction||je&&r.nodeType===oe.comment&&Y(/<[/\w]/g,r.data))return ae(r),!0;if(He[u]||!(ue.tagCheck instanceof Function&&ue.tagCheck(u))&&!z[u]){if(!He[u]&&wn(u)&&(B.tagNameCheck instanceof RegExp&&Y(B.tagNameCheck,u)||B.tagNameCheck instanceof Function&&B.tagNameCheck(u)))return!1;if(Yt&&!re[u]){const _=y(r),E=w(r);if(E&&_){const j=E.length;for(let O=j-1;O>=0;--O){const U=Kt?E[O]:T(E[O],!0);_.insertBefore(U,A(r))}}}return ae(r),!0}return(I?I(r):r.nodeType)===oe.element&&!Cs(r)||(u==="noscript"||u==="noembed"||u==="noframes")&&Y(/<\/no(script|embed|frames)/i,r.innerHTML)?(ae(r),!0):(he&&r.nodeType===oe.text&&(c=r.textContent,de([lt,dt,ct],_=>{c=Se(c,_," ")}),r.textContent!==c&&(_e(e.removed,{element:r.cloneNode()}),r.textContent=c)),pe(G.afterSanitizeElements,r,null),!1)},yn=function(r,c,u){if(pt[c]||rn&&(c==="id"||c==="name")&&(u in t||u in As))return!1;const v=$[c]||ue.attributeCheck instanceof Function&&ue.attributeCheck(c,r);if(!(qt&&!pt[c]&&Y(xs,c))){if(!(nn&&Y(ys,c))){if(!v||pt[c]){if(!(wn(r)&&(B.tagNameCheck instanceof RegExp&&Y(B.tagNameCheck,r)||B.tagNameCheck instanceof Function&&B.tagNameCheck(r))&&(B.attributeNameCheck instanceof RegExp&&Y(B.attributeNameCheck,c)||B.attributeNameCheck instanceof Function&&B.attributeNameCheck(c,r))||c==="is"&&B.allowCustomizedBuiltInElements&&(B.tagNameCheck instanceof RegExp&&Y(B.tagNameCheck,u)||B.tagNameCheck instanceof Function&&B.tagNameCheck(u))))return!1}else if(!Jt[c]){if(!Y(an,Se(u,tn,""))){if(!((c==="src"||c==="xlink:href"||c==="href")&&r!=="script"&&Ea(u,"data:")===0&&cn[r])){if(!(sn&&!Y(ws,Se(u,tn,"")))){if(u)return!1}}}}}}return!0},Os=S({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),wn=function(r){return!Os[$e(r)]&&Y(vs,r)},vn=function(r){pe(G.beforeSanitizeAttributes,r,null);const c=r.attributes;if(!c||mt(r))return;const u={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:$,forceKeepAttr:void 0};let v=c.length;for(;v--;){const _=c[v],E=_.name,j=_.namespaceURI,O=_.value,U=P(E),fe=O;let W=E==="value"?fe:xi(fe);if(u.attrName=U,u.attrValue=W,u.keepAttr=!0,u.forceKeepAttr=void 0,pe(G.uponSanitizeAttribute,r,u),W=u.attrValue,ln&&(U==="id"||U==="name")&&Ea(W,dn)!==0&&(ve(E,r),W=dn+W),je&&Y(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,W)){ve(E,r);continue}if(U==="attributename"&&Sa(W,"href")){ve(E,r);continue}if(u.forceKeepAttr)continue;if(!u.keepAttr){ve(E,r);continue}if(!on&&Y(/\/>/i,W)){ve(E,r);continue}he&&de([lt,dt,ct],_n=>{W=Se(W,_n," ")});const Tn=P(r.nodeName);if(!yn(Tn,U,W)){ve(E,r);continue}if(L&&typeof h=="object"&&typeof h.getAttributeType=="function"&&!j)switch(h.getAttributeType(Tn,U)){case"TrustedHTML":{W=Ee(W);break}case"TrustedScriptURL":{W=hs(W);break}}if(W!==fe)try{j?r.setAttributeNS(j,E,W):r.setAttribute(E,W),mt(r)?ae(r):_a(e.removed)}catch{ve(E,r)}}pe(G.afterSanitizeAttributes,r,null)},kt=function(r){let c=null;const u=bn(r);for(pe(G.beforeSanitizeShadowDOM,r,null);c=u.nextNode();)if(pe(G.uponSanitizeShadowNode,c,null),xn(c),vn(c),Oe(c.content)&&kt(c.content),(I?I(c):c.nodeType)===oe.element){const _=q?q(c):c.shadowRoot;Oe(_)&&(na(_),kt(_))}pe(G.afterSanitizeShadowDOM,r,null)},na=function(r){const c=[{node:r,shadow:null}];for(;c.length>0;){const u=c.pop();if(u.shadow){kt(u.shadow);continue}const v=u.node,E=(I?I(v):v.nodeType)===oe.element,j=w?w(v):v.childNodes;if(j)for(let O=j.length-1;O>=0;--O)c.push({node:j[O],shadow:null});if(E){const O=H?H(v):null;if(typeof O=="string"&&P(O)==="template"){const U=v.content;Oe(U)&&c.push({node:U,shadow:null})}}if(E){const O=q?q(v):v.shadowRoot;Oe(O)&&c.push({node:null,shadow:O},{node:O,shadow:null})}}};return e.sanitize=function(f){let r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},c=null,u=null,v=null,_=null;if(Xt=!f,Xt&&(f="<!-->"),typeof f!="string"&&!Ge(f)&&(f=_i(f),typeof f!="string"))throw be("dirty is not a string, aborting");if(!e.isSupported)return f;Gt||ta(r),e.removed=[];const E=Kt&&typeof f!="string"&&Ge(f);if(E){const U=H?H(f):f.nodeName;if(typeof U=="string"){const fe=P(U);if(!z[fe]||He[fe])throw be("root node is forbidden and cannot be sanitized in-place")}if(mt(f))throw be("root node is clobbered and cannot be sanitized in-place");try{na(f)}catch(fe){throw mn(f),fe}}else if(Ge(f))c=kn("<!---->"),u=c.ownerDocument.importNode(f,!0),u.nodeType===oe.element&&u.nodeName==="BODY"||u.nodeName==="HTML"?c=u:c.appendChild(u),na(u);else{if(!Ae&&!he&&!we&&f.indexOf("<")===-1)return L&&ut?Ee(f):f;if(c=kn(f),!c)return Ae?null:ut?V:""}c&&Wt&&ae(c.firstChild);const j=bn(E?f:c);try{for(;v=j.nextNode();)xn(v),vn(v),Oe(v.content)&&kt(v.content)}catch(U){throw E&&mn(f),U}if(E)return de(e.removed,U=>{U.element&&Rs(U.element)}),he&&aa(f),f;if(Ae){if(he&&aa(c),gt)for(_=ms.call(c.ownerDocument);c.firstChild;)_.appendChild(c.firstChild);else _=c;return($.shadowroot||$.shadowrootmode)&&(_=bs.call(a,_,!0)),_}let O=we?c.outerHTML:c.innerHTML;return we&&z["!doctype"]&&c.ownerDocument&&c.ownerDocument.doctype&&c.ownerDocument.doctype.name&&Y(Pi,c.ownerDocument.doctype.name)&&(O="<!DOCTYPE "+c.ownerDocument.doctype.name+`>
`+O),he&&de([lt,dt,ct],U=>{O=Se(O,U," ")}),L&&ut?Ee(O):O},e.setConfig=function(){let f=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ta(f),Gt=!0},e.clearConfig=function(){Re=null,Gt=!1,L=Ut,V=""},e.isValidAttribute=function(f,r,c){Re||ta({});const u=P(f),v=P(r);return yn(u,v,c)},e.addHook=function(f,r){typeof r=="function"&&_e(G[f],r)},e.removeHook=function(f,r){if(r!==void 0){const c=ki(G[f],r);return c===-1?void 0:bi(G[f],c,1)[0]}return _a(G[f])},e.removeHooks=function(f){G[f]=[]},e.removeAllHooks=function(){G=Na()},e}var Bi=Pa();let Ma=!1;function Ui(){Ma||(Ma=!0,C.setOptions({gfm:!0,breaks:!0}))}function Fi(s){return String(s).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Hi(s){let e=Bi.sanitize(s,{ADD_ATTR:["target","rel"]});return e=e.replace(/<a\s+([^>]*?)>/gi,(t,a)=>(/\btarget\s*=/i.test(a)||(a+=' target="_blank"'),/\brel\s*=/i.test(a)||(a+=' rel="noopener noreferrer"'),"<a "+a+">")),e}function Qe(s){if(!s)return"";try{Ui();const e=C.parse(s,{async:!1});return Hi(e)}catch(e){return console.warn("[AIAgent SDK] marked parse failed, fallback:",e),ji(s)}}function ji(s){let e=Fi(s);return e=e.replace(/`([^`\n]+)`/g,"<code>$1</code>"),e=e.replace(/\*\*([^*\n]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\n/g,"<br/>"),e}function et(s){if(!s)return;const e=s.querySelectorAll("img");for(let t=0;t<e.length;t++){const a=e[t];if(a.dataset.aiagentDecorated==="1")continue;a.dataset.aiagentDecorated="1",a.setAttribute("loading","lazy"),a.classList.add("aiagent-sdk-img-loading");const n=()=>{a.classList.remove("aiagent-sdk-img-loading"),a.classList.add("aiagent-sdk-img-loaded")};a.complete&&a.naturalWidth>0?n():(a.addEventListener("load",n,{once:!0}),a.addEventListener("error",n,{once:!0}))}}const tt=`
/* ====================================================================
 * 设计令牌
 * ==================================================================== */
:host {
...
`,za={cornerGlow:!0,statusDotStyle:"rainbow",sendIcon:"svg",messageEnter:"paint",bubbleAnimation:"rotate",fontStack:"mixed"};function at(s){return{...za,...s}}function $a(s,e){return{...s,...e,layout:at({...s.layout,...e.layout})}}const xe={name:"iridescent-bloom",css:tt,palette:"ink",aiHint:"深色油彩画布 + 4 角油彩飞溅 + 虹彩动画 + 毛玻璃。视觉强烈,默认皮肤。",layout:{cornerGlow:!0,statusDotStyle:"rainbow",sendIcon:"svg",messageEnter:"paint",bubbleAnimation:"rotate",fontStack:"mixed"}},nt={name:"classic",css:qi,aiHint:"浅灰白底 + 蓝色强调 + 系统字体 + 无装饰动画。商务/简洁风格,亮色环境。",layout:{cornerGlow:!1,statusDotStyle:"pulse",sendIcon:"arrow",messageEnter:"fade",bubbleAnimation:"none",fontStack:"system"}},Dt=$a(xe,{name:"aurora",css:tt+`
`+`
