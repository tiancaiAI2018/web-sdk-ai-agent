...
${g}`:g,i=i?`${i}
${h}`:h;const k=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,o,!0),this.lexer.state.top=k,a.length===0)break;const x=o[o.length-1];if(x?.type==="code")break;if(x?.type==="blockquote"){const y=x,C=y.raw+`
`+a.join(`
`),E=this.blockquote(C);o[o.length-1]=E,n=n.substring(0,n.length-y.raw.length)+E.raw,i=i.substring(0,i.length-y.text.length)+E.text;break}else if(x?.type==="list"){const y=x,C=y.raw+`
`+a.join(`
`),E=this.list(C);o[o.length-1]=E,n=n.substring(0,n.length-x.raw.length)+E.raw,i=i.substring(0,i.length-y.raw.length)+E.raw,a=C.substring(o[o.length-1].raw.length).split(`
