...
${p}`:p,s=s?`${s}
${f}`:f;const k=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(f,o,!0),this.lexer.state.top=k,n.length===0)break;const u=o[o.length-1];if(u?.type==="code")break;if(u?.type==="blockquote"){const b=u,S=b.raw+`
`+n.join(`
`),_=this.blockquote(S);o[o.length-1]=_,a=a.substring(0,a.length-b.raw.length)+_.raw,s=s.substring(0,s.length-b.text.length)+_.text;break}else if(u?.type==="list"){const b=u,S=b.raw+`
`+n.join(`
`),_=this.list(S);o[o.length-1]=_,a=a.substring(0,a.length-u.raw.length)+_.raw,s=s.substring(0,s.length-b.raw.length)+_.raw,n=S.substring(o[o.length-1].raw.length).split(`
